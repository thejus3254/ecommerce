  ...
  try {
    ...
    if (parseInt(productCountResult.rows[0].count) === 0) {
      ...
      const seedProductsQuery = `
            ...
            ('Calligraphy Pen', 'Premium fountain pen with 3 nibs', 30.00, 'https://images.unsplash.com/photo-1585336261022-680e295a4843?auto=format&fit=crop&q=80', 'Pens', 75),
            ...
            ('Wooden Studio Easel', 'Adjustable H-frame floor easel for large canvases', 89.99, 'https://images.unsplash.com/photo-1518984950450-7164ea222de8?auto=format&fit=crop&q=80', 'Equipment', 15),
            ('Canvas Panels Pack', 'Set of 5 11x14 inch primed cotton canvas boards', 24.50, 'https://images.unsplash.com/photo-1579783900882-c0d3dad7b119?auto=format&fit=crop&q=80', 'Canvas', 120),
            ('Alcohol Markers Set', '36 dual-tip professional illustration blenders', 45.00, 'https://images.unsplash.com/photo-1521120098171-050dbfaa04c4?auto=format&fit=crop&q=80', 'Markers', 60),
            ('Self-Healing Cutting Mat', 'A3 size double-sided metric/imperial grid', 19.95, 'https://images.unsplash.com/photo-1621255536551-768a35eeccd1?auto=format&fit=crop&q=80', 'Equipment', 90),
            ('Workable Fixative Spray', '11oz spray to prevent smudging on charcoal and pastels', 14.25, 'https://images.unsplash.com/photo-1572947118128-091702eac3f2?auto=format&fit=crop&q=80', 'Mediums', 85),
            ('Porcelain Mixing Palette', '12-well heavy ceramic palette for watercolors', 21.00, 'https://images.unsplash.com/photo-1543857778-c4a1a3e0b2eb?auto=format&fit=crop&q=80', 'Accessories', 40)
        `;
